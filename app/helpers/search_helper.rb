...
module SearchHelper
  ...
  def project_select_tag
    ...
    options << [l(:label_and_its_subprojects, @project.language_name), 'subprojects'] unless @project.nil? || @project.descendants.active.empty?
    options << [@project.language_name, ''] unless @project.nil?
