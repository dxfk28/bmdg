...
Rails.application.routes.draw do
  ...
  match '/issues/get_name', :to => 'issues#get_name', :via => :get
  ...
  match '/plugin_issues/context_menu', :to => 'context_menus#plugin_issues', :as => 'plugin_issues_context_menu', :via => [:get, :post]
